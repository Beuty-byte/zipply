...
const configs: Record<string, {
    ...
    jpeg: {
        ...
        description: {
            en: 'Compress JPEG images online for free. Reduce file size while maintaining high quality. No registration required.',
        ...
        faq: {
            en: [
                { question: 'How does JPEG compression work?', answer: 'JPEG compression reduces file size by removing redundant data while preserving visual quality. At 80% quality, the difference is barely visible.' },
                { question: 'Is it free to compress JPEG images?', answer: 'Yes, completely free. No registration required. No limits on file size or number of compressions.' },
                { question: 'Can I compress multiple JPEG files at once?', answer: 'Yes, you can upload multiple files and download them as a ZIP archive.' },
                { question: 'What quality should I choose?', answer: '80-85% is ideal for websites. 60-70% is good for email attachments.' },
            ],
            es: [
                { question: '¿Cómo funciona la compresión JPEG?', answer: 'La compresión JPEG reduce el tamaño del archivo eliminando datos redundantes.' },
            ],
            pt: [
                { question: 'Como funciona a compressão JPEG?', answer: 'A compressão JPEG reduz o tamanho do arquivo removendo dados redundantes.' },
            ],
            fr: [
                { question: 'Comment fonctionne la compression JPEG?', answer: 'La compression JPEG réduit la taille du fichier en supprimant les données redondantes.' },
            ],
            de: [
                { question: 'Wie funktioniert die JPEG-Komprimierung?', answer: 'Die JPEG-Komprimierung reduziert die Dateigröße durch Entfernen redundanter Daten.' },
            ],
            ru: [
                { question: 'Как работает сжатие JPEG?', answer: 'Сжатие JPEG уменьшает размер файла, удаляя избыточные данные. При качестве 80% разница почти незаметна.' },
                { question: 'Это бесплатно?', answer: 'Да, полностью бесплатно. Без регистрации и ограничений.' },
                { question: 'Можно сжать несколько файлов?', answer: 'Да, загрузите несколько файлов и скачайте ZIP-архив.' },
    ...
    png: {
        ...
        faq: {
            en: [
                ...
                { question: 'Is it free?', answer: 'Yes, completely free. No registration required.' },
            ],
            ru: [
